...
/*!*****************************************!*\
  !*** ./resources/js/cadastro_vendas.js ***!
  \*****************************************/
console.log('oi');
...
function adicionarItem() {
  ...
  produtosSelect.onchange = function () {
    atualizarValor(produtosSelect);
  };
  ...
  quantidadeInput.onchange = function () {
    atualizarValorQtd(quantidadeInput);
  };
...
function continuar() {
  var selectProdutosForm = document.getElementById("select-produtos");
  var pagamentoForm = document.getElementById("pagamento");
